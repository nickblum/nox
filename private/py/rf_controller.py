...
def send_command(timeout=6):
    ...
    while failures < 1:
        ...
        if not result:
            ...
            print("Transmission success. Started Listening...")
            radio.startListening()  # put radio in RX mode
            ...
            while (time.monotonic() - start_timer) < timeout:
                ...
                if has_payload:
                    ...
                    #break loops with timeout & failures
                    timeout = 0
                    failures = 2
            """
        ...
        radio.powerDown()
        time.sleep(1)
    print(failures, "End send_command()")
...
def set_role():
    ...
    if user_input[0].upper().startswith("R"):
        ...
        master()
        return True
    elif user_input[0].upper().startswith("D"):
        send_command()
        return True
...
if __name__ == "__main__":
    ...
    """
    # we're just gonna call you radio 1
    args.node = 1
